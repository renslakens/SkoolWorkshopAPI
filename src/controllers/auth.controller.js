...
let controller = {
  ...
  register: (req, res, next) => {
    ...
    bcrypt.hash(wachtwoord, saltRounds, function (err, hash) {
      ...
      let sqlDocent =
        "INSERT INTO Docent (voornaam, achternaam, geboortedatum, geboorteplaats, maxRijafstand, heeftRijbewijs, heeftAuto, straat, huisnummer, geslacht, woonplaats, postcode, land, isFlexwerker, loginEmail) VALUES ?";
